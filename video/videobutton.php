...
<center><a href="addvideo.php" id="myButton" class="fancybox fancybox.ajax"><i class="fa fa-plus"><br></i><br> Ajouter</a>

<a href="videoExport.php" id="myButton"><i class="fa fa-file-excel-o"><br></i><br> Excel</a>
