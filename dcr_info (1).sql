...
--
-- Hôte : 127.0.0.1
-- Généré le :  jeu. 04 oct. 2018 à 02:00
...
INSERT INTO `carte_sims` (`id`, `codification`, `sim`, `balise`, `telephone`, `IDPORT`, `immatriculation`, `statut`, `RFID`, `navigation`, `LC`, `pesee`, `origin`) VALUES
...
(24, 'N250', '89331042120317970506', 'AO51SI1', '06 18 54 38 22', 'ID : 9 Port : 2518', 'CP-842-KF', 'EN SERVICE', 'COMPTAGE OK', '15', 'TERBERG', 'PME Flux continu', 'sssssssss'),
...
(53, 'N283', '89333101307078413167', 'A05TN62', '06 17 92 22 12', 'ID : 895380 Port : 2516', 'N227 EV-098-BM', 'EN SERVICE', 'PB RFID DEPUIS RECEP', '44', 'TERBERG', 'PME Flux continu', '31'),
...
(65, 'N228', '', 'A05PHZ1', '06 18 54 38 94', 'ID : 73 Port : 2555', '938-AEX-76', 'EN SERVICE', '', 'OUI', '', '', '0000000');
...
CREATE TABLE `radio` (
  `id` int(11) NOT NULL,
  `numero_appel` text COLLATE utf8_bin NOT NULL,
  `codification` text COLLATE utf8_bin NOT NULL,
  `numero_serie` text COLLATE utf8_bin NOT NULL,
  `type` text COLLATE utf8_bin NOT NULL,
  `statut` text COLLATE utf8_bin NOT NULL,
  `modele` text COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
(1, '5428', 'N228', '1pn..........', 'portatif', 'EN SERVICE', 'stp9040'),
(2, '5736', 'N231', '', '', '', ''),
(3, '5418', 'N232', '', '', '', ''),
(4, '5649', 'N233', '', '', '', ''),
(5, '5674', 'N234', '', '', '', ''),
...
(72, '5329', 'LECROQ PH', '', '', '', ''),
(73, '5846', 'DUMENIL L', '', '', '', ''),
(74, '5330', 'LOPES/RECHER', '', '', '', ''),
(75, '5820', 'IVECO', '', '', '', ''),
(76, '5850', 'EMO G', '', '', '', ''),
(77, '5738', 'BLANCHARD L', '', '', '', ''),
(78, '5977', 'PERMANENCE CDR', '', '', '', ''),
(79, '5632', 'CORAILLER Y', '', '', '', ''),
(80, '5976', 'MARIETTE PH', '', '', '', ''),
(81, '5732', 'TOUTAIN F', '', '', '', ''),
(82, '5803', 'VASSEUR F', '', '', '', ''),
(83, '5646', 'LERIBLER M', '', '', '', ''),
(84, '5742', 'DEVARIEUX JL', '', '', '', ''),
(85, '5733', 'LEROUX D', '', '', '', ''),
(86, '5731', 'Astreinte S‚curit‚', '', '', '', ''),
(87, '5978', 'Permanence D‚chŠterie', '', '', '', ''),
(88, 'klk', 'klk', 'lkl', 'klkl', 'klk', 'lkl');
